...
class IMG_Stegno:
    ...
    def decode_frame1(self, F):
        ...
        button_bws = Button(
            d_f2, text="Select", command=lambda: self.decode_frame2(d_f2)
        )
        button_bws.config(font=("Helvetica", 18), bg="#e8c1c7")
        button_bws.grid()
        button_back = Button(
            d_f2, text="Cancel", command=lambda: IMG_Stegno.back(self, d_f2)
        )
        button_back.config(font=("Helvetica", 18), bg="#e8c1c7")
        button_back.grid(pady=15)
        button_back.grid()
    ...
    def encode_frame2(self, e_F2):
        ...
        if not myfile:
            ...
            encode_button = Button(
                e_pg, text="Cancel", command=lambda: IMG_Stegno.back(self, e_pg)
            )
    ...
    def decode_frame2(self, d_F2):
        ...
        if not myfiles:
            ...
            text_a.grid()
            button_back = Button(
                d_F3, text="Cancel", command=lambda: self.frame_3(d_F3)
            )
            button_back.config(font=("Helvetica", 14), bg="#e8c1c7")
            button_back.grid(pady=15)
            button_back.grid()
    ...
    def decode(self, image):
        ...
        while True:
            pixels = [
                value
                for value in image_data.__next__()[:3]
